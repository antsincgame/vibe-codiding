  ...
  const sendTestEmail = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${import.meta.env.VITE_API_URL}/send-test-email`,
        {
          method: 'POST',
          headers: {
        ...
        <div>
          ...
          <div style={{
            ...
            <ol style={{ fontSize: '13px', opacity: 0.8, paddingLeft: '20px', lineHeight: '1.8' }}>
              ...
              <li>Endpoint URL: <code style={{ background: 'rgba(0,0,0,0.3)', padding: '2px 6px', borderRadius: '4px' }}>{import.meta.env.VITE_API_URL}/functions/v1/resend-webhook</code></li>
