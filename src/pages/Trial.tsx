...
const SEO = {
  ...
  description: 'Бесплатный пробный урок вайбкодинга! Попробуй Cursor AI и Bolt.new, создай первый проект за 1.5 часа. Вайбкодинг для начинающих от 16 лет - онлайн занятие без обязательств. Запишись и начни создавать сайты с ИИ!',
  keywords: 'пробный урок вайбкодинга, вайбкодинг бесплатно попробовать, Cursor AI пробное занятие, Bolt.new демо, записаться на вайбкодинг'
};
