...
const SEO = {
  title: 'Пробный урок Vibecoding - Бесплатное занятие',
  description: 'Запишитесь на бесплатный пробный урок вайб-кодинга в Vibecoding. Знакомство с Cursor AI и Bolt.new, первый проект на занятии. Онлайн для подростков и взрослых.',
  keywords: 'пробный урок, бесплатное занятие, вайб кодинг бесплатно, Cursor AI попробовать, Bolt.new демо, записаться на курс, обучение программированию бесплатно'
};
