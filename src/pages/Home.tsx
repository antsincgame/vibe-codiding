...
const defaultSettings: HomePageSettings = {
  ...
  meta_description: 'Научитесь создавать сайты и веб-приложения с нуля. Школа Vibecoding предлагает инновационный подход к обучению веб-разработке для подростков и взрослых.',
  meta_keywords: 'школа программирования гродно, курсы программирования в гродно, курсы программирования с нуля, как делать сайты, веб-разработка, обучение программированию, подростки',
};
      ...
      <section style={{
        ...
        <div className="cyber-card" style={{ marginBottom: '60px' }}>
          ...
          <p style={{
            ...
            Вайб-кодинг (vibe coding) — это современный метод разработки программ с помощью искусственного интеллекта, который был представлен в 2025 году исследователем AI Андреем Карпати из OpenAI. Вместо написания кода строка за строкой, вы просто общаетесь с AI-помощником на обычном языке, описывая что хотите создать, а искусственный интеллект превращает ваши идеи в работающие приложения. Наша <strong>школа программирования в Гродно</strong> использует вайб-кодинг как основу обучения.
          </p>
          <p style={{
            fontSize: '18px',
            lineHeight: '1.8',
            ...
            Это означает, что программирование теперь доступно каждому — <strong>курсы программирования с нуля в Гродно</strong> помогут вам начать путь в IT независимо от возраста, образования или предыдущего опыта.
          </p>
        </div>
        ...
        <p style={{
          ...
          <strong>Курсы программирования в Гродно</strong> для подростков от 16 лет и взрослых. У нас есть два курса — они различаются только технологиями, занятия проходят в раздельных группах.
        </p>
      ...
      <section style={{
        ...
        <div className="cyber-card" style={{ marginBottom: '60px' }}>
          ...
          <p style={{ fontSize: '18px', lineHeight: '1.9', marginBottom: '20px', opacity: 0.95, textAlign: 'center' }}>
            Хотите узнать, <strong>как делать сайты</strong>? В Гродно наша школа проведет вас через весь путь создания веб-проекта — от первоначальной идеи до запуска готового сайта и привлечения клиентов. Сложные технические темы объясняются простым и понятным языком, делая <strong>обучение программированию</strong> доступным для каждого.
          </p>
        ...
        <div style={{
          ...
          <div className="cyber-card" style={{
            ...
            <p style={{
              ...
              Свяжитесь с нами, чтобы записаться на <strong>курсы программирования с нуля в Гродно</strong> и узнать больше о расписании
            </p>
      ...
      <section style={{
        ...
        <div className="cyber-card" style={{ padding: '40px' }}>
          <h2 style={{
            ...
            Школа программирования в Гродно — Vibecoding
          </h2>
          <div style={{
            fontSize: '16px',
            lineHeight: '1.9',
            ...
            <p style={{ marginBottom: '20px' }}>
              <strong>Vibecoding</strong> — это современная <strong>школа программирования в Гродно</strong>, где вы научитесь создавать сайты, веб-приложения и цифровые продукты с использованием инновационного подхода вайб-кодинга. Наши <strong>курсы программирования в Гродно</strong> подходят как для подростков от 16 лет, так и для взрослых, которые хотят освоить востребованную профессию или получить новые навыки.
            </p>
            <p style={{ marginBottom: '20px' }}>
              Если вы давно задаетесь вопросом «<strong>как делать сайты</strong>» и хотите научиться создавать их самостоятельно — наши <strong>курсы программирования с нуля</strong> помогут вам в этом. Мы не требуем предварительной подготовки: все объясняется простым языком, а искусственный интеллект становится вашим помощником в написании кода.
            </p>
            <p style={{ marginBottom: '20px' }}>
              <strong>Обучение программированию</strong> в Vibecoding включает практические проекты, которые вы сможете добавить в портфолио. Вы научитесь работать с современными инструментами разработки, размещать сайты в интернете, настраивать домены и применять базовые SEO-техники для привлечения посетителей.
            </p>
            <p>
              Записывайтесь на <strong>курсы программирования в Гродно</strong> уже сегодня и откройте для себя мир веб-разработки с Vibecoding!
            </p>
          </div>
        </div>
      </section>
