...
const defaultSettings: HomePageSettings = {
  ...
  meta_title: 'Vibecoding - Курсы вайб-кодинга 2025 | Cursor AI и Bolt.new обучение',
  meta_description: 'Научись создавать сайты и приложения с нуля за 2 месяца! Курсы вайб-кодинга с Cursor AI и Bolt.new. Практика с первого занятия, портфолио, сертификат. Онлайн обучение для начинающих от 16 лет. Запишись на бесплатный пробный урок!',
  meta_keywords: 'вайб кодинг, vibe coding, Cursor AI курсы, Bolt.new обучение, создание сайтов с ИИ, программирование с нейросетью, AI разработка, веб-приложения без кода, курсы программирования онлайн 2025, обучение веб-разработке, no-code, low-code, ИИ программирование',
};
