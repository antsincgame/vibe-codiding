...
const defaultSettings: HomePageSettings = {
  ...
  meta_keywords: 'программирование, веб-разработка, обучение, гродно, курсы, подростки',
};
    ...
    <div style={{ minHeight: '100vh' }}>
      ...
      <section style={{
        ...
        <p style={{
          ...
          У нас есть два курса они различаются только технологиями, подходят как для подростков от 16 лет так и для взрослых, занятия проходят в раздельных группах
        </p>
