...
const SEO = {
  title: 'Преподаватели Vibecoding | Дмитрий Орлов и Игорь Сухоцкий - эксперты AI-разработки',
  description: 'Знакомьтесь с преподавателями школы вайб-кодинга Vibecoding. Дмитрий Орлов - 15+ лет в IT, основатель веб-студии, эксперт Cursor AI и Bolt.new. Игорь Сухоцкий - senior-разработчик, 7+ лет PHP, архитектор систем. Учитесь у практиков!',
  keywords: 'преподаватели вайб кодинга, Дмитрий Орлов программист, Игорь Сухоцкий разработчик, Cursor AI эксперт, Bolt.new специалист, senior разработчик Минск, архитектор систем, IT менторы, веб-разработка обучение 2025'
};
