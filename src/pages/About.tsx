...
const SEO = {
  title: 'Преподаватели Vibecoding - Дмитрий Орлов и Игорь Сухоцкий',
  description: 'Команда Vibecoding: Дмитрий Орлов - 15 лет в IT, эксперт Cursor AI и Bolt.new. Игорь Сухоцкий - senior-разработчик, архитектор систем. Практикующие специалисты.',
  keywords: 'преподаватели вайб кодинга, Дмитрий Орлов, Игорь Сухоцкий, Cursor AI эксперт, Bolt.new специалист, senior разработчик, архитектор систем, IT менторы, веб-разработка обучение'
};
