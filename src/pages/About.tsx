...
const SEO = {
  ...
  description: 'Преподаватели школы вайбкодинга Vibecoding: Дмитрий Орлов - 15+ лет в IT, эксперт Cursor AI и Bolt.new. Игорь Сухоцкий - senior-разработчик, архитектор систем. Учись вайбкодингу у практикующих специалистов!',
  keywords: 'преподаватели вайбкодинга, обучение вайбкодингу, Cursor AI эксперт, Bolt.new специалист, менторы вайбкодинга, Vibecoding учителя'
};
