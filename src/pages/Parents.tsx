  ...
  const faqs = [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          a: 'От 16 лет. Подростки и взрослые полностью готовы к обучению.'
        },
        {
          q: 'Мой подросток боится сломать компьютер?',
          a: 'Это нормальный страх! Объясните: "Компьютер не сломается. Максимум мы перезагрузим браузер."'
        },
        {
          q: 'Не будет ли это слишком сложно?',
          a: 'Нет! ИИ делает это очень простым. Даже если подросток никогда не программировал - справится.'
        },
        {
          q: 'А если подросток не умеет печатать быстро?',
          a: 'Это не нужно. Печатание приходит со временем. Главное понимание логики.'
        },
        {
          q: 'Можно ли заработать денег?',
    ...
    },
    {
      ...
      questions: [
        {
          q: 'Что получит ученик в конце курса?',
        ...
        },
        {
          ...
          a: 'В 16-17 лет: фриланс работа ($5-20 за проект). В 17-18 лет: стажировка в IT компании. В 18+: junior разработчик ($500-1500 в месяц).'
        },
        {
        ...
        },
        {
          ...
          a: 'Если ученик посещает регулярно и делает домашние задания - гарантия 100%.'
        }
      ]
    }
  ];
    ...
    <div style={{
      ...
      <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
        ...
        <p style={{
          ...
          Как помочь подростку преуспеть в курсе программирования
        </p>
        ...
        <div className="cyber-card" style={{
          ...
          <h2 style={{
            ...
            КАК ПОМОЧЬ ПОДРОСТКУ (15 минут в день)
          </h2>

          <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            {[
              { num: '1', text: 'Спросите: "Что новое ты выучил сегодня?"' },
              { num: '2', text: 'Посмотрите: проекты (покажет ссылки на Netlify)' },
              { num: '3', text: 'Похвалите: конкретно за что-то ("Крутой дизайн!", "Умная идея!")' },
              { num: '4', text: 'Помогите: если застрял на домашнем задании (но не делайте вместо ученика!)' }
            ].map((item) => (
        ...
        <div className="cyber-card" style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
            {[
              'Подросток хочет идти на занятия',
        ...
        <div className="cyber-card" style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '15px', marginBottom: '30px' }}>
            {[
              'Подросток говорит "Это слишком сложно"',
