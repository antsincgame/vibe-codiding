...
const SEO = {
  title: 'FAQ Vibecoding | Вопросы и ответы о курсах вайб-кодинга 2025',
  description: 'Все ответы о курсах Vibecoding: сколько стоит обучение, как проходят занятия, какой компьютер нужен, можно ли совмещать с работой. Узнайте о трудоустройстве после курса Cursor AI и Bolt.new. Возврат денег если не подойдёт!',
  keywords: 'FAQ вайб кодинг, вопросы о курсах программирования, стоимость обучения Cursor AI, как проходят онлайн занятия, требования к обучению, карьера после IT курсов, Bolt.new FAQ, работа после курсов'
};
